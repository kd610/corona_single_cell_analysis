...
def main(num_dataset_sampling=1, num_kfold=5):
    ...
    adata = sc.read_h5ad('./data/gse176269_input_DP_covid_normalized_preprocessed.h5ad')
    ...
    for i in range(num_dataset_sampling):       
        ...
        for rep in ['X_pca', 'X_umap']:
            ...
            for k in tqdm(range(num_kfold)):
                ...
                adata_concat.write(f"./data/k{k}_{rep_name}_adata_inputDP_GSE_176269_COVID19.h5ad") # type: ignore
