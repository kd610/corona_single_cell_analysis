...
def main(num_kfold=5):
    # Read adata
    print("Starting the experiment for sample classification in scenario 3.1 with DP: PCA(X)+gaussian noise...")
...
if __name__ == "__main__":
    ...
    print("Done experiment of scenario 3.1 DP!")
