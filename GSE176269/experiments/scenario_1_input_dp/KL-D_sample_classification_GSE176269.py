...
def main(num_kfold=5):
    ...
    print("Start scenario 1 with input DP: GSE176269")
    ...
    for rep in ['X_pca', 'X_umap']:
        ...
        for k in tqdm(range(num_kfold)):
            ...
            ext_covid_vector = df_pds.query("batch == 'ref' and sample.str.contains('Cov')")['basis_value'].values
            ext_non_covid_vector = df_pds.query("batch == 'ref' and not sample.str.contains('Cov')")['basis_value'].values
            ...
            n_sample_covid = np.linspace(-lim+5, lim+5, 26)
