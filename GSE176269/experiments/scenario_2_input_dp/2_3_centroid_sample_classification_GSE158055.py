...
def main(num_kfold=5):
    print("Start scenario 2.3 with input DP: GSE176269")
    ...
    for rep in ['X_pca', 'X_umap']:
        ...
        for k in range(num_kfold):
            ...
            # order the dataframe by the sampleID
            ...
            #df_exist = df_exist.sample(frac=1, random_state=RANDOM_SEED).reset_index(drop=True)
