...
def main(num_kfold=5, num_nearest_samples=3):
    print("Start scenario 2.4 with input DP: GSE176269")
    # Read adata
    result_rep = dict()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_nearest_samples', type=int, help='Number of k nearest neighbors')
    # Parse the arguments
    args = parser.parse_args()

    print(f"Running the experiment of scenario 2.4 with knn={args.num_nearest_samples}...")
    main(num_kfold=args.num_kfold, num_nearest_samples=args.num_nearest_samples)
    print(f"Done experiment of scenario 2.4 with knn={args.num_nearest_samples}...")
