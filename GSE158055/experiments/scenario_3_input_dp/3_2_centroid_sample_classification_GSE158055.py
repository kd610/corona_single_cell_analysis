...
def main(num_kfold=5):
    print("Starting the experiment for sample classification in scenario 3.2 with DP: Input pertubation")
    # Read adata
...
if __name__ == "__main__":
    ...
    print("Done experiment of scenario 3.2 DP (input pertubation)!")
