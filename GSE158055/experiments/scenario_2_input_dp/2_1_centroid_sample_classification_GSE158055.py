...
def main(num_kfold=5):
    print("Starting the experiment for sample classification in scenario 2.1 with DP: Input pertubation")
    # Read adata
...
if __name__ == "__main__":
    ...
    print("Done experiment of scenario 2.1 DP (input pertubation)!")
