...
if __name__ == "__main__":
    ...
    print(f"Running the experiment of scenario 2.4 (input pertubation) with knn={args.num_nearest_samples}...")
    main(num_kfold=args.num_kfold, num_nearest_samples=args.num_nearest_samples)
    print(f"Done experiment of scenario 2.4 DP (input pertubation) with knn={args.num_nearest_samples}...")
